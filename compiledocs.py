...
def concatenate_mdx_files(dir_names, output_dir="compiled/mintlify"):
    for dir_name in dir_names:
        ...
        with open(os.path.join(output_dir, f"{dir_base_name}.mdx"), 'w') as new_file:
            new_file.write(concatenated_content)

        print(f"Concatenated file created for directory: {dir_name}")

# Example usage
dir_names = ["docs-main/content/components"]  # Replace with your directory names
